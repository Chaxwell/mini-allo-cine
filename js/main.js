...
for (let n = 0; n < moisi.length; n++) {
    document.getElementById("card").innerHTML += `
    <div class="card mx-5 my-4 bg-verysoftgray border border-dark">
        <div class="row">
            <div class="col-sm-3 col-md-3">
                <img class="card-img my-3 ml-4 mr-4 img-responsive" src="${moisi[n].Poster}" alt="Image poster">
            </div>
            <div class="col-sm-9 col-md-9">
                <div class="card-body">
                    <h3 class="card-title mb-4">${moisi[n].Title}</h3>
                    <p class="card-text text-justify">
                        ${moisi[n].Title} est un super film de ${moisi[n].Genre} du génie ${moisi[n].Director}.<br>
                        Sorti le ${moisi[n].Released}, sa durée est de ${moisi[n].Runtime}. Dans ce film vous
                        trouverez les acteurs ${moisi[n].Actors}.<br>
                        Synopsis :<br>
                        ${moisi[n].Plot}<br>
                        Vainqueur des prix ${moisi[n].Awards} !
                    </p>
                </div>
            </div>
        </div>
...
// for (let x = 0; x < moisi[n]['Images'].length ; x++) {
//     document.getElementById("card").innerHTML += `
//     <img class="img-responsive" src="${moisi[n]['Images'][x]}" alt"Pres image">`;
// }
// document.getElementById("card").innerHTML += ``
